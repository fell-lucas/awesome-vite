...
- [chrome-extension-template-preact-vite](https://github.com/fell-lucas/chrome-extension-template-preact-vite) - Preact, Tailwind CSS, TypeScript, Jest, Prettier, ESLint, GitHub Actions and Chrome Extension Manifest v3.
